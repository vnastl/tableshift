...
causal_features.remove(domain)
causal_subsets = select_subset_minus_one(causal_features)
ACS_UNEMPLOYMENT_FEATURES_CAUSAL_SUBSETS = []
for subset in causal_subsets:
    subset.append(target)
    subset.append(domain)
    ACS_UNEMPLOYMENT_FEATURES_CAUSAL_SUBSETS.append(FeatureList(subset))
...
ACS_UNEMPLOYMENT_FEATURES_ARGUABLYCAUSAL_SUPERSETS_NUMBER = len(arguablycausal_supersets)
