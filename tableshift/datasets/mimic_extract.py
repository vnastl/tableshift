...
domain = Feature("insurance", cat_dtype,
            "Medicare, Private, Medicaid, Government, Self Pay.")
causal_features = MIMIC_EXTRACT_LOS_3_FEATURES_CAUSAL.features.copy()
...
for subset in causal_subsets:
    ...
    MIMIC_EXTRACT_LOS_3_FEATURES_CAUSAL_SUBSETS.append(FeatureList(subset))
MIMIC_EXTRACT_LOS_3_FEATURES_CAUSAL_SUBSETS_NUMBER = len(causal_subsets)
...
domain = Feature("insurance", cat_dtype,
            "Medicare, Private, Medicaid, Government, Self Pay.")
causal_features = MIMIC_EXTRACT_MORT_HOSP_FEATURES_CAUSAL.features.copy()
causal_features.remove(target)
causal_features.remove(domain)
causal_subsets = select_subset_minus_one(causal_features)
...
for subset in causal_subsets:
    subset.append(target)
    subset.append(domain)
    MIMIC_EXTRACT_MORT_HOSP_FEATURES_CAUSAL_SUBSETS.append(FeatureList(subset))
MIMIC_EXTRACT_MORT_HOSP_FEATURES_CAUSAL_SUBSETS_NUMBER = len(causal_subsets)
