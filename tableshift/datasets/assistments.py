...
ASSISTMENTS_FEATURES_CAUSAL = FeatureList(features=[
    ...
    documentation="https://www.kaggle.com/datasets/nicolaswattiez/skillbuilder-data-2009-2010 ,"
                  "https://sites.google.com/site/assistmentsdata/datasets/2012-13-school-data-with-affect")
causal_features = ASSISTMENTS_FEATURES_CAUSAL.features.copy()
...
ASSISTMENTS_FEATURES_CAUSAL_SUBSETS = []
for subset in causal_subsets:
    subset.append(target)
    subset.append(domain)
    ASSISTMENTS_FEATURES_CAUSAL_SUBSETS.append(FeatureList(subset))
ASSISTMENTS_FEATURES_CAUSAL_SUBSETS_NUMBER = len(causal_subsets)
...
ASSISTMENTS_FEATURES_ARGUABLYCAUSAL = FeatureList(features=[
    ...
    documentation="https://www.kaggle.com/datasets/nicolaswattiez/skillbuilder-data-2009-2010 ,"
                  "https://sites.google.com/site/assistmentsdata/datasets/2012-13-school-data-with-affect")
arguablycausal_supersets = select_superset_plus_one(ASSISTMENTS_FEATURES_ARGUABLYCAUSAL.features, ASSISTMENTS_FEATURES.features)
ASSISTMENTS_FEATURES_ARGUABLYCAUSAL_SUPERSETS = []
for superset in arguablycausal_supersets:
    ASSISTMENTS_FEATURES_ARGUABLYCAUSAL_SUPERSETS.append(FeatureList(superset))
ASSISTMENTS_FEATURES_ARGUABLYCAUSAL_SUPERSETS_NUMBER = len(arguablycausal_supersets)
